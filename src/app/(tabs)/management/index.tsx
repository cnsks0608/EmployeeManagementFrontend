  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        <Card style={styles.navigationCard} onPress={() => router.push('/(tabs)/management/employees')}>
        ...
        <Card style={styles.navigationCard} onPress={() => router.push('/(tabs)/management/users')}>
        ...
        <Card style={styles.navigationCard} onPress={() => router.push('/(tabs)/management/logs')}>
