...
type ManagementEmployeeSortModalProps = {
  visible: boolean;
  onClose: () => void;
...
const sortOptions = [
  ...
  { label: 'Maaş (Artan)', sortBy: 'salary', sortDirection: 'asc' },
  { label: 'Maaş (Azalan)', sortBy: 'salary', sortDirection: 'desc' },
  { label: 'İşe Giriş (Eski-Yeni)', sortBy: 'hireDate', sortDirection: 'asc' },
  { label: 'İşe Giriş (Yeni-Eski)', sortBy: 'hireDate', sortDirection: 'desc' },
];

export function ManagementEmployeeSortModal({ visible, onClose, onApply, currentSortBy, currentSortDirection }: ManagementEmployeeSortModalProps) {
