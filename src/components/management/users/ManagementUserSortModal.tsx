...
type ManagementUserSortModalProps = {
  visible: boolean;
  onClose: () => void;
...
const sortOptions = [
  { label: 'Varsayılan Sıralama', sortDirection: undefined },
  { label: 'Kullanıcı Adı (A-Z)', sortDirection: 'asc' },
  { label: 'Kullanıcı Adı (Z-A)', sortDirection: 'desc' },
];

export function ManagementUserSortModal({ visible, onClose, onApply, currentSortDirection }: ManagementUserSortModalProps) {
