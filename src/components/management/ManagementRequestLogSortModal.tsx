...
type ManagementRequestLogSortModalProps = {
  visible: boolean;
  onClose: () => void;
...
export function ManagementRequestLogSortModal({ visible, onClose, onApply, currentSortDirection }: ManagementRequestLogSortModalProps) {
